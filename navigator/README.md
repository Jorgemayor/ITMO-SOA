...
4. Once the runtime starts, you can access the project at http://localhost:8080/navigator
...
```
docker run -p 8080:8080 navigator:${project.version}
```
Replace navigator:${project.version} with the actual image name and tag.
